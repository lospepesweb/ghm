...
$('.editarVideo').click(function(){
	...
	$('#'+idVideo).html('<div class="col-12"><form id="formEditarVideo" method="POST" enctype="multipart/form-data" class="row"><div class="col-12 col-lg-6"><input type="text" name="tit_esp_n" placeholder="Título en español" value="'+tit_esp+'"><textarea name="noti_esp_n" class="" maxlength="150" placeholder="Noticia en español">'+noti_esp+'</textarea></div><div class="col-12 col-lg-6"><input type="text" name="tit_ing_n" placeholder="Título en ingles" value="'+tit_ing+'"><textarea name="noti_ing_n" class="" maxlength="150" placeholder="Noticia en ingles">'+noti_ing+'</textarea></div><div class="col-12 col-lg-6 inputfile-container"><input type="file" name="nuevoVideo" id="nuevoVideo" class=""></div><input type="hidden" value="'+idVideo+'" name="id"><input type="hidden" value="'+rutaVideo+'" name="videoAntiguo"><div class="col-12 col-lg-6 d-flex justify-content-lg-end"><input type="submit" name="" class="btn-default" value="Guardar cambios"></div></form></div>');
