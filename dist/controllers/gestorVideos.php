...
class Videos {
	...
	public function seleccionarVideosControllerIngles(){

		$respuesta = VideosModel::seleccionarVideosModelIngles('videos');
		...
		foreach ($respuesta as $row => $item) {
			...
			echo '<div class="video-container">
					...
					<div class="noticia d-flex align-items-center">
						<div class="col-12">
							<h6 class="titulo">'.$item['tit_ing'].'</h6>
							<p class="texto">'.$item['noti_ing'].'</p>
						</div>
					</div>
				  </div>';			
