		...
		<div class="container lang-container d-none d-lg-block">
			<div class="row">
				<div class="col-2 text-right ml-auto">
					<a href="../es/index.php" id="langEsp" class="lang">ES</a>
					...
					<div id="lang-container" class="container lang-container d-block d-lg-none">
						<div class="row">
							<div class="col-12 text-left">
								<a href="../es/index.html" id="langEsp" class="lang">ES</a>
								<span class="lang">/</span>
								<a href="#" id="langEng" class="lang active">EN</a>
							</div>
						</div>
	...
	<div class="container-fluid">
		<div class="row mt-5">
			<div class="col-12 text-center">
				<p class="titulo" style="margin-top: 200px; margin-bottom: 400px; color:#959494">We are translating this page.</p>
			</div>
		</div>
	</div>
...
<!-- 	<section id="noticias" class="videos">
		<div class="video1">
			<video src="../video/sarmiento.mp4" type="video/mov" autoplay="true" loop="true" height="100%" width="100%"></video>
			<div class="noticia d-flex align-items-center">
				<div class="col-12">
					<h6 class="titulo">RELANZAMIENTO WEB SARMIENTO</h6>
					<p class="texto">El 11 de septiembre del corriente se lanzó el nuevo sitio web de "Los viajes de Sarmiento" presentando nuevas secciones y contenidos.</p>
				</div>
			</div>
		</div>
		<div class="video2">
			<video src="../video/perito.mp4" type="video/mov" autoplay="true" loop="true" height="100%" width="100%"></video>
			<div class="noticia d-flex align-items-center">
				<div class="col-12">
					<h6 class="titulo">EL PERITO MORENO</h6>
					<p class="texto">Adelanto exclusivo de la nueva película que estamos realizando sobre los viajes del Perito Moreno.</p>
				</div>
			</div>
		</div>
		<div class="video3">
			<video src="../video/mustang.mp4" type="video/mov" autoplay="true" loop="true" height="100%" width="100%"></video>
			<div class="noticia d-flex align-items-center">
				<div class="col-12 ">
					<h6 class="titulo">PRESENTACIÓN NUEVO FORD MUSTANG | 2017</h6>
					<p class="texto">Testeamos el nuevo modelo de Mustang durante el rodaje del comercial 2017.</p>
				</div>
			</div>
		</div>
		<div class="video4">
			<video src="../video/ballenas.mp4" type="video/mov" autoplay="true" loop="true" height="100%" width="100%"></video>
			<div class="noticia d-flex align-items-center">
				<div class="col-12">
					<h6 class="titulo">PATAGONIA ARGENTINA</h6>
					<p class="texto">Recorrido exclusivo por los paisajes más australes de la Patagonia Argentina.</p>
				</div>
			</div>
		</div>
	</section>
...
<!-- 	<section id="equipo" class="index container equipo">
		...
		<div class="row justify-content-center">
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-01.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-02.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-03.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-04.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-05.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-06.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-07.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-08.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-09.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-10.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
			...
			<div class="col-6 col-lg-4 text-center fila">
				<figure>
					<img src="../img/INDEX-EQUIPO-GHM-11.png" class="img-fluid" alt="Gustavo Muñoz">
					<figcaption>
